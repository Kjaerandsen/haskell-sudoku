...
```
cd existing_repo
git remote add origin https://git.gvk.idi.ntnu.no/course/prog2006/as/jonask/project/haskell-sudoku.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.gvk.idi.ntnu.no/course/prog2006/as/jonask/project/haskell-sudoku/-/settings/integrations)
